...
public:
	...
	unique_ptr<ParsedExpression> QualifyColumnName(const string &column_name, string &error_message, bool prioritise_current_aliases);
	unique_ptr<ParsedExpression> QualifyColumnName(ColumnRefExpression &colref, string &error_message, bool prioritise_current_aliases);
	...
	static void QualifyColumnNames(Binder &binder, unique_ptr<ParsedExpression> &expr, bool prioritise_current_aliases = false);
